...
parser.add_argument('--noise_dir', default='C:\\Users\\Rasu\\Downloads\\Mini projects\\Speech-enhancement-master\\demo_data\\validation', type=str)

parser.add_argument('--voice_dir', default='/Users/Rasu/Downloads/Mini projects/Audio Denoising/test', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/Users/Rasu/Downloads/Mini projects/Audio Denoising/spectrograms/', type=str)

parser.add_argument('--path_save_time_serie', default='/Users/Rasu/Downloads/Mini projects/Audio Denoising/time series/', type=str)

parser.add_argument('--path_save_sound', default='/Users/Rasu/Downloads/Mini projects/Audio Denoising/sounds/', type=str)
...
parser.add_argument('--dir_save_prediction', default='./save_predictions/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['sample1.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='sample_output1.wav', type=str)
